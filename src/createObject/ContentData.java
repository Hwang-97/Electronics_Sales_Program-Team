...
{		
	...
	static
	{
		...
		{	
			...
			BufferedReader reader = new BufferedReader(new FileReader("..\\JavaTest\\src\\project1\\data\\상품 문의.txt"));
			...
			reader = new BufferedReader(new FileReader("..\\JavaTest\\src\\project1\\data\\상품 리뷰.txt"));
	...
	{
		String path = "..\\JavaTest\\src\\project1\\data\\";
